...
urlpatterns = [
    path('register', views.RegisterForm.as_view(template_name='register.html'), name='register'),
    ...
    path('post/<int:pk>/add_coment', views.AddCommentView.as_view(), name='add_comment'),
